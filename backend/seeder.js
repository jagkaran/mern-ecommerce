...
async function uploadToCloudinary(remoteUrl, folder = "products") {
  try {
    ...
    const fb = await cloudinary.uploader.upload(`https://picsum.photos/seed/${seed}/800/800`, {
      folder,
      resource_type: "image",
    });
...
const PRODUCTS_DATA = [
  // ── FOOTWEAR (16) ────────────────────────────────────────────────────────
  {
    ...
    description:
      "Experience incredible energy return with Boost cushioning. The Ultraboost 23 features a Primeknit+ upper for a sock-like fit, a Continental rubber outsole for superior grip, and a Linear Energy Push system for smooth heel-to-toe transitions.",
    price: 189.95,
    category: "footwear",
    stock: 42,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "An icon of tennis-court style since the 1970s. Clean leather upper, perforated 3-Stripes, the iconic green heel tab, and Ortholite cushioning for all-day comfort.",
    price: 94.95,
    category: "footwear",
    stock: 80,
    imageUrls: [
  ...
  },
  {
    name: "Adidas NMD_R1",
    description:
      "Street style meets premium comfort. Full-length Boost cushioning, Primeknit upper, and iconic midsole plugs for all-day city wear.",
    price: 129.95,
    category: "footwear",
    stock: 55,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Born on the football pitch in the 1950s. Low-profile leather upper, suede T-toe overlay, and gum rubber outsole — a timeless cultural icon.",
    price: 99.95,
    category: "footwear",
    stock: 63,
    imageUrls: [
  ...
  },
  {
    name: "Adidas Gazelle",
    description:
      "A vintage icon remastered. Soft suede upper, serrated 3-Stripes, low-cut silhouette. Originally a multi-sport shoe, now a streetwear essential.",
    price: 89.95,
    category: "footwear",
    stock: 70,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "The shell-toe legend. Introduced in 1969 as a basketball shoe, the Superstar transcended sport to become one of the most iconic sneakers of all time.",
    price: 89.95,
    category: "footwear",
    stock: 95,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Hailing from basketball courts in 1984. Velcro strap ankle support, bold leather upper, and distinctive tooled rubber cupsole.",
    price: 99.95,
    category: "footwear",
    stock: 38,
    imageUrls: [
  ...
  },
  {
    name: "Adidas Ozweego",
    description:
      "Future-forward chunky runner with a mixed-material upper, foam pods in the midsole, and a bulky outsole — a statement of bold style and everyday comfort.",
    price: 119.95,
    category: "footwear",
    stock: 44,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Clean lines and a retro tennis-court aesthetic. Full-grain leather upper, cupsole construction, and contrast stitching details.",
    price: 84.95,
    category: "footwear",
    stock: 50,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Engineered for the modern game. Controlskin upper with rubber elements for enhanced ball control, a compression fit collar, and a sprint frame soleplate.",
    price: 219.95,
    category: "footwear",
    stock: 25,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Speed-engineered boots with a Speedskin upper for minimal water absorption, Speedframe outsole, and asymmetric lacing for maximum strike zone.",
    price: 199.95,
    category: "footwear",
    stock: 20,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Our lightest Ultraboost ever. Light Boost foam delivers legendary energy return at 30% less weight, paired with a Linear Energy Push system and Continental rubber outsole.",
    price: 179.95,
    category: "footwear",
    stock: 35,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Born in handball gyms of Europe. Low-profile suede upper, contrast leather toe cap, and gum outsole — an icon that has influenced street culture for decades.",
    price: 94.95,
    category: "footwear",
    stock: 48,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "The Campus silhouette redefined for a new generation. Slightly oversized proportions, suede upper, and iconic 3-Stripes bridge archival and contemporary style.",
    price: 99.95,
    category: "footwear",
    stock: 58,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Technical hiking boot with Boost midsole, GORE-TEX waterproof membrane, and Continental rubber outsole for confident grip on any terrain.",
    price: 219.95,
    category: "footwear",
    stock: 18,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "The silhouette that changed sneaker culture. Full-length Boost midsole, Primeknit upper with monofilament side stripe, and semi-translucent outsole. Limited stock.",
    price: 229.95,
    category: "footwear",
    stock: 8,
    imageUrls: [
  ...
  // ── TOPS (13) ──────────────────────────────────────────────────────────────
  {
    ...
    description:
      "A wardrobe essential in soft cotton jersey with classic 3-Stripes down the sleeves. Regular fit, ribbed crew neck, embroidered Adidas logo at the chest.",
    price: 24.95,
    category: "tops",
    stock: 150,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Soft cotton jersey, relaxed fit, bold embroidered Trefoil at the chest. The Trefoil tee is an Originals icon that belongs in every casual wardrobe.",
    price: 27.95,
    category: "tops",
    stock: 120,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "A heritage icon. Slim-fit track top in smooth tricot fabric with ribbed cuffs, embroidered Trefoil, and 3-Stripes down the sleeves.",
    price: 74.95,
    category: "tops",
    stock: 65,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Train at your best with AEROREADY moisture-absorbing technology, zip-up collar, and the iconic Tiro silhouette. Lightweight and breathable for serious sessions.",
    price: 44.95,
    category: "tops",
    stock: 88,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Heritage meets everyday comfort. Kangaroo pocket, adjustable drawcord hood, brushed fleece interior, Trefoil logo at the left chest.",
    price: 64.95,
    category: "tops",
    stock: 72,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Relaxed warmth in soft fleece. Crew neck, small embroidered Adidas logo, clean minimal styling. The everyday sweatshirt that pairs with everything.",
    price: 44.95,
    category: "tops",
    stock: 95,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Lightweight water-resistant nylon, full-zip front, packable hood, bold 3-Stripes down the sleeves in a vintage colourway. An Originals legend reworked.",
    price: 84.95,
    category: "tops",
    stock: 40,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Made with recycled polyester and AEROREADY technology to keep you dry. Reflective details for low-light visibility and a relaxed fit for easy movement.",
    price: 34.95,
    category: "tops",
    stock: 110,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "A perennial Originals classic. Smooth tricot fabric, mock neck full-zip, rib cuffs, and 3-Stripes down the sleeves define this timeless SST silhouette.",
    price: 69.95,
    category: "tops",
    stock: 55,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Lightweight and packable for runs in changeable weather. AEROREADY technology, packable hood, and reflective details combine performance with practicality.",
    price: 79.95,
    category: "tops",
    stock: 45,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Technical fleece for mountain adventures. Warm, breathable, moisture-wicking, full zip, hood, zippered hand pockets, and hem drawcord for a secure fit.",
    price: 109.95,
    category: "tops",
    stock: 30,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Clean, sport-inspired tee featuring the classic Badge of Sport graphic. Soft cotton, regular fit, crew neck — a simple iconic look for off-duty days.",
    price: 27.95,
    category: "tops",
    stock: 130,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Competition-grade training jacket with slim fit, AEROREADY technology, soft-touch finish. The 1/4-zip design with reflective logo is perfect for warm-up.",
    price: 59.95,
    category: "tops",
    stock: 52,
    imageUrls: [
  ...
  // ── BOTTOM (8) ────────────────────────────────────────────────────────────
  {
    ...
    description:
      "Go-to training shorts in soft French terry with elastic waistband, front zip pockets, and 3-Stripes down the sides. Comfortable on and off the pitch.",
    price: 29.95,
    category: "bottom",
    stock: 140,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Iconic football training pants with AEROREADY technology, slim-fit silhouette, ankle zips, and signature Tiro side panels. Built for serious athletes.",
    price: 44.95,
    category: "bottom",
    stock: 85,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "An Originals classic. Smooth tricot fabric, 3-Stripes down the legs, side pockets, and an elastic drawcord waistband for all-day comfort.",
    price: 64.95,
    category: "bottom",
    stock: 70,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Lightweight running shorts with built-in briefs, back zip pocket, and reflective details. AEROREADY keeps moisture away from your skin.",
    price: 34.95,
    category: "bottom",
    stock: 90,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "A fire-bird legacy in a modern silhouette. Contrasting colour body, 3-Stripes down the legs, side zip pockets, and elastic waistband.",
    price: 69.95,
    category: "bottom",
    stock: 55,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Lightweight stretchy woven hiking pants with zip-off legs, cargo pockets, UPF rating, and a secure waistband with belt loops.",
    price: 79.95,
    category: "bottom",
    stock: 35,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Comfortable everyday joggers in soft cotton single jersey. 3-Stripes down sides, ribbed cuffs, side pockets, and drawcord waistband. Regular-tapered fit.",
    price: 44.95,
    category: "bottom",
    stock: 100,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "AEROREADY training shorts with slim fit, elastic waistband, and 3-Stripes. Perfect for gym sessions, warm-ups, and recovery days.",
    price: 29.95,
    category: "bottom",
    stock: 115,
    imageUrls: [
  ...
  // ── ACCESSORIES (6) ───────────────────────────────────────────────────────
  {
    ...
    description:
      "Six-panel cap with a curved brim, metal eyelets, and an embroidered Trefoil logo. Adjustable strap closure fits most head sizes.",
    price: 24.95,
  ...
  },
  {
    ...
    description:
      "Spacious everyday backpack — large main compartment, front zippered pocket, padded back panel, adjustable straps, and a tonal Trefoil logo. 28 litres.",
    price: 44.95,
    category: "accessories",
    stock: 75,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Cushioned crew socks with arch support and 3-Stripes ankle ribbing. 3-pack to keep your sock game strong all week. One size fits most.",
    price: 16.95,
    category: "accessories",
    stock: 300,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Cosy ribbed-knit beanie with a Badge of Sport embroidered logo. Stretchy fabric fits most head sizes and keeps you warm on cold training days.",
    price: 22.95,
    category: "accessories",
    stock: 160,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Versatile duffel with large main compartment, zippered front pocket, end zip shoe pocket, and adjustable padded shoulder strap. Perfect for gym and travel.",
    price: 49.95,
    category: "accessories",
    stock: 60,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Terry cloth headband + 2 wristbands with moisture-wicking properties. Keeps sweat out of your eyes during intense sessions. Classic look, practical performance.",
    price: 14.95,
    category: "accessories",
    stock: 220,
    imageUrls: [
  ...
  // ── CLOTHING (7) ──────────────────────────────────────────────────────────
  {
    ...
    description:
      "Heritage-inspired full-zip hoodie in heavyweight fleece with 3-Stripes down the sleeves, kangaroo pocket, and adjustable hood. Relaxed fit.",
    price: 79.95,
    category: "clothing",
    stock: 60,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Packable insulated vest for cold-weather outdoor adventures. 700-fill recycled down, water-repellent finish, two-way front zip. Packs into its own chest pocket.",
    price: 149.95,
    category: "clothing",
    stock: 22,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Bold winter jacket with PrimaLoft insulation, water-repellent finish, detachable hood, and archive-inspired graphics. Made with 70%+ recycled materials.",
    price: 189.95,
    category: "clothing",
    stock: 15,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Match-ready football shorts with AEROREADY technology, elastic waistband with internal drawcord, and iconic Tiro side panels. Slim fit.",
    price: 29.95,
    category: "clothing",
    stock: 100,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Minimal and breathable running vest in lightweight AEROREADY fabric. Wide armholes, reflective logo, and a back zip pocket for your essentials.",
    price: 29.95,
    category: "clothing",
    stock: 75,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Official replica jersey of the New Zealand All Blacks. AEROREADY fabric, iconic silver fern badge, and a slim performance fit.",
    price: 89.95,
    category: "clothing",
    stock: 30,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Lightweight woven training shorts with elastic waistband, side pockets, and 3-Stripes. Regular fit ideal for gym workouts and sport.",
    price: 27.95,
    category: "clothing",
    stock: 120,
    imageUrls: [
...
async function destroyData() {
  ...
  console.log(
    `   Deleted → Users: ${u.deletedCount}  Products: ${p.deletedCount}  Orders: ${o.deletedCount}`
  );
...
async function seedData() {
  ...
  for (let i = 0; i < PRODUCTS_DATA.length; i++) {
    ...
    process.stdout.write(
      `  [${String(i + 1).padStart(2, "0")}/${PRODUCTS_DATA.length}] ${data.name}…`
    );
  ...
  for (let i = 0; i < 20; i++) {
    ...
    const taxPrice = price(itemPrice * 0.2);
    ...
    console.log(
      `  ✔ Order ${String(i + 1).padStart(2, "0")} — ${orderStatus.padEnd(11)} — £${totalPrice}`
    );
  }
