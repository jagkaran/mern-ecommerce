...
const PageLoader = () => (
  <div className="app-loader" style={{ width: 32, height: 32, border: '2px solid var(--t-neutral-200)', borderTopColor: 'var(--t-primary-600)', borderRadius: '50%', margin: '80px auto' }} />
);
...
stripeApiKey ? (
<Elements stripe={loadStripe(stripeApiKey)}><Shipping /></Elements>
) : <PageLoader />
} />
